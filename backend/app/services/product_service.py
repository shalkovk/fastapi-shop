...
class ProductService:
    ...
    def get_all_products(self) -> ProductListResponse:
        ...
        products_reponse = [ProductResponse.model_validate(
            product) for product in products]
        return ProductListResponse(products=products_reponse, total=len(products_reponse))
    ...
    def get_product_by_category(self, category_id: int) -> ProductListResponse:
        ...
        products_response = [ProductResponse.model_validate(
            product) for product in products]
    ...
    def create_product(self, product_data: ProductCreate) -> ProductResponse:
        ...
        if not category:
            raise HTTPException(
                ...
                detail=f"Category with id {product_data.category_id}"
            )
